...
var language = Kekule.language || (global.navigator? navigator.language || navigator.browserLanguage: DEF_LANGUAGE);
...
var saveLocModuleInfo = !!(global || global.window).__kekuleMarkLocalizationModuleInfo__;  // set this extra global var to true to save module information
var locModuleInfo = {};
...
require("./en/kekule.localize.extras.openbabel.en")(Kekule)
require("./en/kekule.localize.general.en")(Kekule)
require("./en/kekule.localize.objDefines.en")(Kekule)
require('./en/kekule.localize.widget.en')(Kekule)
